...
class CreatePaymentForOrderService
{
    public function execute(
        ...
        curl_setopt($ch, CURLOPT_URL, "https://myinboxmedia.in/api/mim/SendSMS?userid=MIM2300278&pwd=".$password."&mobile=971".ltrim($shipping_data->phone, $shipping_data->phone[0])."&sender=Ahmedper&msg=".urlencode('"Dear '. $shipping_data->name .', Thank you for your order '. $order->code .'. Your order is being processed. Please wait for confirmation call! Your Total Bill = '. floatval($order->amount) .'"')."&msgtype=16");
                                                                                                        ...
                                                                                                        <tbody>
                                                                                                            ...
                                                                                                            foreach ($order_products as $key => $value) {
                                                                                                                $body .= '<tr>
                                                                                                                    ...
                                                                                                                    <td style="color:#636363;text-align:left;vertical-align:middle;padding:12px;border:1px solid #E5E5E5;">
                                                                                                                        <div style="font-family:Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;text-align:left;">د.إ'.$value->price.'</div>
                                                                                                                    </td>
                                                                                                                </tr>';    
                                                                                                            }
                                                                                                            ...
                                                                                                            <tr>
                                                                                                                ...
                                                                                                                <td style="color:#636363;text-align:left;vertical-align:middle;padding:12px;border:1px solid #E5E5E5;">
                                                                                                                    <div style="font-family:Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;text-align:left;">
                                                                                                                        '.($order->shipping_amount == '0.00' ? 'You Got Free Shipping' :  $order->shipping_amount).'د.إ
                                                                                                                    </div>
                                                                                                                </td>
                                                                                                            ...
                                                                                                            <tr>
                                                                                                                ...
                                                                                                                <td style="color:#636363;text-align:left;vertical-align:middle;padding:12px;border:1px solid #E5E5E5;">
                                                                                                                    <div style="font-family:Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;text-align:left;">د.إ'.$order->service_amount.'</div>
                                                                                                                </td>
                                                                                                            </tr>
                                                                                                            <tr>
                                                                                                                <th style="color:#636363;text-align:left;vertical-align:middle;padding:12px;border:1px solid #E5E5E5;" colspan="2">
                                                                                                                ...
                                                                                                                <td style="color:#636363;text-align:left;vertical-align:middle;padding:12px;border:1px solid #E5E5E5;">
                                                                                                                    <div style="font-family:Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;text-align:left;">د.إ'.$order->amount.'
                                                                                                                        <small style="font-family:Helvetica Neue,Helvetica,Roboto,Arial,sans-serif;">
                                                                                                                            <div style="text-align:left;">(includes د.إ'.$order->tax_amount.' VAT)</div>
                                                                                                                        </small>
                                                                                                                    </div>
                                                                                                                </td>
                                                                                                            </tr>

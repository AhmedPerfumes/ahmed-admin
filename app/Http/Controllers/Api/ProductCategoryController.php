...
class ProductCategoryController extends Controller
{
    ...
    public function getProductCategoriesTemp(Request $request)
    {
        ...
        $pop_up = Page::select('name', 'name_ar', 'content', 'content_ar', 'description', 'description_ar', 'image', 'mobile_image', 'link')->where('template', 'full-width')->where('status', 'published')->get();
        $top_header=ProductAttribute::select('title','color')->get();
        $sale_section = Page::select('name', 'name_ar', 'content', 'content_ar', 'description', 'description_ar', 'image', 'mobile_image', 'link')->where('template', 'homepage')->where('status', 'published')->get();
        $shop_pop_up = Page::select('name', 'name_ar', 'content', 'content_ar', 'description', 'description_ar', 'image', 'mobile_image', 'link')->where('template', 'coming-soon')->where('status', 'published')->get();
